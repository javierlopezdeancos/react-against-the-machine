...
exports.MachineProvider = exports.MachineContext = void 0;
...
var MachineContext = (0, react_1.createContext)(defaultState);
...
var MachineProvider = /** @class */ (function (_super) {
    ...
    MachineProvider.prototype.render = function () {
        ...
        return (react_1.default.createElement(MachineContext.Provider, { value: {
                prevId: prevId,
                currentId: currentId,
...
var useMachine = function () { return (0, react_1.useContext)(MachineContext); };
