...
export default function Machine(props) {
    ...
    var isPathNameHostRoot = useCallback(function () { return rl.pathname === '' || rl.pathname === '/'; }, [rl.pathname]);
    var isPathNameInitialState = useCallback(function () { return rl.pathname === '/' + initial; }, [rl.pathname, initial]);
